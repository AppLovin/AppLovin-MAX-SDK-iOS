...
s.source = 
{ 
  :http => "https://artifacts.applovin.com/ios/com/applovin/mediation/ironsource-adapter/#{s.name}-#{s.version}.zip",
  :type => 'zip'
}

s.vendored_frameworks = "#{s.name}-#{s.version}/#{s.name}.xcframework"

s.dependency 'IronSourceSDK/Ads', '= {ADAPTER_SDK_VERSION}'

...
## 9.6.0.0.0
* Certified with IronSource SDK 9.6.0.0.
...
## 9.4.1.0.0
* Certified with IronSource SDK 9.4.1.0.

## 9.4.0.0.0
* Certified with IronSource SDK 9.4.0.0.

## 9.3.0.0.0
* Certified with IronSource SDK 9.3.0.0.

## 9.2.0.0.0
* Certified with IronSource SDK 9.2.0.0.

## 9.1.0.0.0
* Certified with IronSource SDK 9.1.0.0.
...
## 7.9.1.0.0
* Certified with IronSource SDK 7.9.1.0.

## 7.9.0.0.0
* Certified with IronSource SDK 7.9.0.0.

## 7.8.0.0.1
* Fixed to allow multiple banners/MRECs with same instanceId in a session to load by destroying previous banners/MRECs using `destroyISDemandOnlyBannerWithInstanceId:` API.

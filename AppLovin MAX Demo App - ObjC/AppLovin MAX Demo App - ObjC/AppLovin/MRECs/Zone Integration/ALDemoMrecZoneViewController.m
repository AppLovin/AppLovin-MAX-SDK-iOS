//
//  ALDemoMrecZoneViewController.m
//  AppLovin MAX Demo App - ObjC
//
//  Created by Nana Amoah on 11/23/21.
//  Copyright © 2021 AppLovin Corporation. All rights reserved.
//

#import "ALDemoMrecZoneViewController.h"
#import <AppLovinSDK/AppLovinSDK.h>

@interface ALDemoMrecZoneViewController() <ALAdLoadDelegate, ALAdDisplayDelegate, ALAdViewEventDelegate>
...
- (void)viewDidLoad
{
    ...
    self.adView = [[ALAdView alloc] initWithSize: ALAdSize.mrec zoneIdentifier: @"YOUR_ZONE_ID"];

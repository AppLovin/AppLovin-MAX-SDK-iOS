 ...
 * AppLovin recommends that you pass these key-value pairs to `trackEvent:parameters:`.
 */
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents the username or account ID of the user. Expects a corresponding value of type `NSString`.
 */
extern NSString *const kALEventParameterUserAccountIdentifierKey;

/**
 * The dictionary key for `trackEvent:parameters:` that identifies a particular piece of content viewed by the user. Expects a corresponding value of type
 * `NSString`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents a search query executed by the user. Expects a corresponding value of type `NSString`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that identifies the level the user has just completed. Expects a corresponding value of type `NSString`.
 */
extern NSString *const kALEventParameterCompletedLevelKey;

/**
 * The dictionary key for `trackEvent:parameters:` that identifies the achievement the user has just completed/unlocked. Expects a corresponding value of type
 * `NSString`.
 */
extern NSString *const kALEventParameterCompletedAchievementKey;

/**
 * The dictionary key for `trackEvent:parameters:` that represents the amount of virtual currency that a user spent on an in-game purchase. Expects a
 * corresponding value of type `NSNumber`.
 */
extern NSString *const kALEventParameterVirtualCurrencyAmountKey;

/**
 * The dictionary key for `trackEvent:parameters:` that represents the name of the virtual currency that a user spent on an in-game purchase. Expects a
 * corresponding value of type `NSString`.
 */
extern NSString *const kALEventParameterVirtualCurrencyNameKey;

/**
 * The dictionary key for `trackEvent:parameters:` that identifies a particular product. Expects a corresponding value of type `NSString`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents the amount of revenue generated by a purchase event. Expects a corresponding value of type
 * `NSNumber`.
 */
extern NSString *const kALEventParameterRevenueAmountKey;

/**
 * The dictionary key for `trackEvent:parameters:` that represents the currency of the revenue event. Expects a corresponding value of type `NSString`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents a unique identifier for the current checkout transaction. Expects a corresponding value of
 * type `NSString`.
 */
extern NSString *const kALEventParameterCheckoutTransactionIdentifierKey;

/**
 * The dictionary key for `trackEvent:parameters:` that represents the StoreKit transaction ID associated with the revenue keys. Expects a corresponding value
 * of type `NSString`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents the StoreKit receipt associated with the revenue keys. Expects a corresponding value of type
 * `NSData`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents the start date of a reservation. Expects a corresponding value of type `NSDate`.
 *
...
/**
 * The dictionary key for `trackEvent:parameters:` that represents the end date of a reservation. Expects a corresponding value of type `NSDate`.
 *

 ...
 */
 // [PLP] what does it mean to "pass up" a property (e.g. passed to whom?)?
 ...
 *
 * AppLovin recommends that you use one of the predefined strings provided in {@link ALEventTypes.h} for the event name, when those strings apply
 * to the event.
 *
 ...
 *
 * AppLovin recommends that you use one of the predefined strings provided in {@link ALEventTypes.h} for the parameter keys, when those strings apply to the
 * event. At a minimum, provide the following parameters: {@link kALEventParameterProductIdentifierKey}, {@link kALEventParameterRevenueAmountKey}, and
 ...
 * Otherwise, we will collect `[[NSBundle mainBundle] appStoreReceiptURL]` and use it for validation.
 *
 * @param transactionIdentifier Value of the `[SKTransaction transactionIdentifier]` property.
 * @param parameters            A dictionary that contains key-value pairs that further describe this event.
 */
 // [PLP] Who is "we"?
 ...
 *
 * @param transactionIdentifier An optional unique identifier for this transaction, generated by you. For Apple Pay transactions, AppLovin suggests using the value of the `[PKPaymentToken transactionIdentifier]` property.
 * @param parameters            A dictionary that contains key-value pairs that further describe this event.
 */

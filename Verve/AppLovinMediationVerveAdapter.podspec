...
s.source = 
{
  :http => 'https://artifacts.applovin.com/ios/com/applovin/mediation/verve-adapter/AppLovinMediationVerveAdapter-2.5.2.0.zip',
  :type => 'zip'
}

s.vendored_frameworks = 'AppLovinMediationVerveAdapter-2.5.2.0/AppLovinMediationVerveAdapter.framework'

s.dependency 'HyBid', '= 2.5.2'

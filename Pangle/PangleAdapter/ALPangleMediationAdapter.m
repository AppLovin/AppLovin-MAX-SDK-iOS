//
//  ALPangleMediationAdapter.m
//  Adapters
//
//  Created by Vedant Mehta on 09/28/22.
...
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter andNotify:(id<MAInterstitialAdapterDelegate>)delegate;
@end

@interface ALPangleRewardedVideoAdDelegate : NSObject<PAGRewardedAdDelegate>
@property (nonatomic,   weak) ALPangleMediationAdapter *parentAdapter;
@property (nonatomic, strong) id<MARewardedAdapterDelegate> delegate;
@property (nonatomic, assign, getter=hasGrantedReward) BOOL grantedReward;
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter andNotify:(id<MARewardedAdapterDelegate>)delegate;
@end

@interface ALPangleAdViewAdDelegate : NSObject<PAGBannerAdDelegate>
@property (nonatomic,   weak) ALPangleMediationAdapter *parentAdapter;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface ALPangleNativeAdViewAdDelegate : NSObject<PAGLNativeAdDelegate>
@property (nonatomic,   weak) MAAdFormat *adFormat;
@property (nonatomic,   weak) ALPangleMediationAdapter *parentAdapter;
@property (nonatomic,   copy) NSString *slotId;
@property (nonatomic, strong) NSDictionary<NSString *, id> *serverParameters;
@property (nonatomic, strong) id<MAAdViewAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter parameters:(id<MAAdapterResponseParameters>)parameters format:(MAAdFormat *)adFormat andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end

@interface ALPangleNativeAdDelegate : NSObject<PAGLNativeAdDelegate>
@property (nonatomic,   weak) ALPangleMediationAdapter *parentAdapter;
@property (nonatomic,   copy) NSString *slotId;
@property (nonatomic, strong) NSDictionary<NSString *, id> *serverParameters;
@property (nonatomic, strong) id<MANativeAdAdapterDelegate> delegate;
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter parameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate;
@end

@interface MAPangleNativeAd : MANativeAd
@property (nonatomic, weak) ALPangleMediationAdapter *parentAdapter;
- (instancetype)initWithParentAdapter:(ALPangleMediationAdapter *)parentAdapter builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock;
- (instancetype)initWithFormat:(MAAdFormat *)format builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock NS_UNAVAILABLE;
@end

@interface ALPangleMediationAdapter()

@property (nonatomic, strong) PAGLInterstitialAd *interstitialAd;
@property (nonatomic, strong) ALPangleInterstitialAdDelegate *interstitialAdDelegate;

@property (nonatomic, strong) PAGRewardedAd *rewardedVideoAd;
@property (nonatomic, strong) ALPangleRewardedVideoAdDelegate *rewardedVideoAdDelegate;

@property (nonatomic, strong) PAGBannerAd *adViewAd;
@property (nonatomic, strong) ALPangleAdViewAdDelegate *adViewAdDelegate;
@property (nonatomic, strong) PAGLNativeAd *nativeAdViewAd;
@property (nonatomic, strong) ALPangleNativeAdViewAdDelegate *nativeAdViewAdDelegate;

@property (nonatomic, strong) PAGLNativeAd *nativeAd;
@property (nonatomic, strong) ALPangleNativeAdDelegate *nativeAdDelegate;

@end

@implementation ALPangleMediationAdapter
static NSTimeInterval const kDefaultImageTaskTimeoutSeconds = 10.0;
static ALAtomicBoolean              *ALPangleInitialized;
static MAAdapterInitializationStatus ALPangleInitializationStatus = NSIntegerMin;

+ (void)initialize
{
    [super initialize];
    
    ALPangleInitialized = [[ALAtomicBoolean alloc] init];
}

- (void)initializeWithParameters:(id<MAAdapterInitializationParameters>)parameters completionHandler:(void (^)(MAAdapterInitializationStatus, NSString * _Nullable))completionHandler
{
    if ( [ALPangleInitialized compareAndSet: NO update: YES] )
    {
        ALPangleInitializationStatus = MAAdapterInitializationStatusInitializing;
        
        PAGConfig *configuration = [PAGConfig shareConfig];
        configuration.userDataString = [self createUserExtData: parameters];
        ...
        [PAGSdk startWithConfig: configuration completionHandler:^(BOOL success, NSError *error) {
            if ( !success || error )
            {
                ...
                ALPangleInitializationStatus = MAAdapterInitializationStatusInitializedFailure;
                completionHandler(ALPangleInitializationStatus, error.localizedDescription);
                return;
            }
            
            [self log: @"Pangle SDK initialized"];
            
            ALPangleInitializationStatus = MAAdapterInitializationStatusInitializedSuccess;
            completionHandler(ALPangleInitializationStatus, nil);
        }];
    }
    else
    {
...
- (void)loadInterstitialAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MAInterstitialAdapterDelegate>)delegate
{
    ...
    [PAGLInterstitialAd loadAdWithSlotID: slotId
        ...
        if ( error )
        {
            MAAdapterError *adapterError = [ALPangleMediationAdapter toMaxError: error];
        ...
        self.interstitialAdDelegate = [[ALPangleInterstitialAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadRewardedAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MARewardedAdapterDelegate>)delegate
{
    ...
    [PAGRewardedAd loadAdWithSlotID: slotId
        ...
        self.rewardedVideoAdDelegate = [[ALPangleRewardedVideoAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
    ...
    dispatchOnMainQueue(^{
        ...
        if ( isNative )
        {
            ...
            [PAGLNativeAd loadAdWithSlotID: slotId request: request completionHandler:^(PAGLNativeAd *_Nullable ad, NSError *_Nullable error) {
                ...
                self.nativeAdViewAdDelegate = [[ALPangleNativeAdViewAdDelegate alloc] initWithParentAdapter: self
        ...
        else
        {
            ...
            [PAGBannerAd loadAdWithSlotID: slotId
                ...
                self.adViewAdDelegate = [[ALPangleAdViewAdDelegate alloc] initWithParentAdapter: self andNotify: delegate];
...
- (void)loadNativeAdForParameters:(id<MAAdapterResponseParameters>)parameters andNotify:(id<MANativeAdAdapterDelegate>)delegate
{
    ...
    dispatchOnMainQueue(^{
        ...
        [PAGLNativeAd loadAdWithSlotID: slotId request: request completionHandler:^(PAGLNativeAd *_Nullable ad, NSError *_Nullable error) {
            ...
            self.nativeAdDelegate = [[ALPangleNativeAdDelegate alloc] initWithParentAdapter: self
                                                                                 parameters: parameters
                                                                                  andNotify: delegate];
...
@implementation ALPangleInterstitialAdDelegate
...
@implementation ALPangleRewardedVideoAdDelegate
...
@implementation ALPangleAdViewAdDelegate
...
@implementation ALPangleNativeAdViewAdDelegate
...
@implementation ALPangleNativeAdDelegate
